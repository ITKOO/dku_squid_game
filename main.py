...
def SecondFrame(event): #첫번째 안내문
    ...
    b = Button(window, text="다음", bg="#393838", fg="white", height=2, width=5)
...
def SixthFrame(event):  # 시간이 지나면 화면 넘어가는거
    ...
    lb.place(x=320,y=320)

    b = Button(window, text="게임 그만두기", bg="#393838", fg="white", height=5, width=40, font=(100))
    b.place(x=410, y=530)
...
def oilnam(event):
    ...
    lb= Label(window,text="당신은 오일남 입니다.",bg="black",fg="white",font=(100))
    lb.place(x=550,y=350)
    lb2 = Label(window, text="게임에서 끝까지 살아남으시길 바랍니다.",bg="black",fg="white",font=(100))
    lb2.place(x=480,y=400)
...
def kangsaebyuk(event):
    ...
    lb= Label(window,text="당신은 강새벽 입니다.",bg="black",fg="white",font=(100))
    lb.place(x=550,y=350)
    lb2 = Label(window, text="게임에서 끝까지 살아남으시길 바랍니다.",bg="black",fg="white",font=(100))
    lb2.place(x=480,y=400)
...
def seongkihun(event):
    ...
    lb= Label(window,text="당신은 성기훈 입니다.",bg="black",fg="white",font=(100))
    lb.place(x=550,y=350)
    lb2 = Label(window, text="게임에서 끝까지 살아남으시길 바랍니다.",bg="black",fg="white",font=(100))
    lb2.place(x=480,y=400)
...
b1 = Button(window, text="게임시작", bg="#393838", fg="white", height=5, width=42, font=(100))
